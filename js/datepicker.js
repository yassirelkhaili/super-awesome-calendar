export default function datepicker(
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const calenderInputContainer = document.querySelector(
      `.${datepickerContainer}`
    );
    ...
    calenderInputContainer &&
      calenderInputContainer.addEventListener("click", () => {
    ...
    const handleCalendarOutsideClick = (event) => {
      ...
      if (
        ...
        !calenderInputContainer.contains(target) &&
        !target.classList.contains("calendar__body__cell")
      ) {
    ...
    const handleResponsiveBehaviour = () => {
      const calendarBottomCoordenates =
        calendar && calendar.getBoundingClientRect().bottom;
      const viewportHeight = window.innerHeight;
      if (calendarBottomCoordenates > viewportHeight) {
        !calendar.classList.contains("calendar--bottom") &&
          calendar.classList.add("calendar--bottom");
        calendar.classList.contains("calendar--top") &&
          calendar.classList.remove("calendar--top");
      }
    };
  });
}
